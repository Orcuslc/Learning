...
\begin{figure}[!ht]
\centering
\includegraphics[width = 12cm]{NumericalSimulation/EuRe0.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width = 12cm]{NumericalSimulation/EuIm0.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width = 12cm]{NumericalSimulation/EbRe0.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width = 12cm]{NumericalSimulation/EbIm0.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width = 12cm]{NumericalSimulation/Egamma0.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width = 12cm]{NumericalSimulation/Varu0.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width = 12cm]{NumericalSimulation/Varb0.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width = 12cm]{NumericalSimulation/Vargamma0.png}
\caption{Simulation of Var($\gamma$)}
\label{Simulation of Var(gamma)}
\end{figure}
在模拟结果中我们可以看到, 对期望和方差的模拟结果和理论结果均比较符合. 而两者的差别在于方程组的初值为一个服从标准正态分布的随机变量, 其期望和方差的模拟值和理论值有一些偏差, 而这样的偏差随着时间$t$的增加而保持. 此外, $b(t)$和$\gamma(t)$的系统误差对$u(t+\Delta t)$的误差会产生影响, 下面我们对这样的影响进行分析. 

\subsection{误差分析}
在这里我们不考虑数值计算舍入误差, 只关注系统误差.
