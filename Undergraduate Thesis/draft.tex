...
\title{{\zihao{1}\heiti{} 随机参数化Kalman滤波模型中一个随机微分方程组解的统计量}}
...
\begin{abstract}
本文研究了随机参数化Kalman滤波模型中一个得到广泛应用的随机微分方程组的解, 利用It\^o积分和特征函数补全了解的一阶和二阶统计量的计算过程, 并对理论结果进行了数值检验. \\
