...
\newcommand{\mx}[1]{\mathit{\mathrm{\mathbf{#1}}}}
...
\normalsize{\color{slateblue}\textbf{Chuan Lu, 13300180056, chuanlu13@fudan.edu.cn}} \\[1mm]
\rule{\textwidth}{0.5mm}
}

\newcommand{\problem}[2] {
\vspace{5pt}
\normalsize{\color{slateblue}\textbf{Problem #1.}}
\vspace{2mm}
#2 \\[5pt]
}
