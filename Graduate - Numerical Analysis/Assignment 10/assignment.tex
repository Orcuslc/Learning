...
\solution{Solution}{
We know the orthogonal functions on $[-1, 1]$ with weight function $w(x) = \frac{1}{\sqrt{1-x^2}}$ are Chebyshev polynomials:
$$
...
Thus
$$
a_0 = (f, T_0) = \int_{-1}^{1} \frac{1}{\sqrt{1-x^2}}\cos^{-1}xdx = \int_{\pi}^{0}-ydy = \frac{\pi^2}{2},
$$
$$
a_1 = (f, T_1) = \int_{-1}^{1}\frac{x}{\sqrt{1-x^2}}\cos^{-1}xdx = \left.\int_{0}^{\pi} y\cos ydy = y\sin y\right|_{0}^{\pi} - \int_{0}^{\pi} \sin ydy = -2,
$$
$$
a_2 = (f, T_2) = \int_{-1}^{1}\frac{2x^2-1}{\sqrt{1-x^2}}\cos^{-1}xdx = \left.\int_{0}^{\pi}y\cos 2ydy = \frac{y\sin 2y}{2}\right|_{0}^{\pi} - \frac{1}{2}\int_{0}^{\pi}\sin 2ydy = -\frac{1}{2}.
$$
Thus
$$
p_2(x) = -\frac{1}{2}x^2-2x+\frac{\pi^2}{2}.
$$
}
\end{document}