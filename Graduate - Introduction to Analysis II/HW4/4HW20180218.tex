...
\textbf{(b)} Define $G, l(z), \gamma$ as in Example 2.10, using the same method of Example 2.10, we can show
$$
\int_{0}^{\infty}\frac{(\log x)^2}{1+z^2}dz = 0.
$$
$$
...
And
$$
\int_{r}^{R}\frac{(\log x)^3}{1+x^2}dx + \int_{-R}^{-r}\frac{(\log |x|+\pi i)^3}{1+x^2}dx = 
$$
